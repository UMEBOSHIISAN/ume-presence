...
test("includes an AivisSpeech process tree for local voice playback", () => {
  const processes = parseMacProcessList(`
  30 1 /Applications/AivisSpeech.app/Contents/MacOS/AivisSpeech /Applications/AivisSpeech.app/Contents/MacOS/AivisSpeech
  31 30 AivisSpeechHelper /Applications/AivisSpeech.app/Contents/Frameworks/AivisSpeechHelper --type=utility
  40 1 /Applications/Music.app/MacOS/Music /Applications/Music.app/MacOS/Music
`);
  assert.deepEqual(selectVoiceProcessTree(processes, { ownProcessId: 99 }), {
    pids: [30, 31],
    rootPids: [30],
